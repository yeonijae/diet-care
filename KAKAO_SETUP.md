...
**이 단계를 빠뜨리면 프로필 정보를 가져올 수 없습니다!**

1. 좌측 메뉴 **제품 설정** → **카카오 로그인** 클릭
2. 아래로 스크롤하여 **동의항목** 섹션 찾기
3. **닉네임** 항목 찾기:
   - 상태: **선택 동의** 또는 **필수 동의**
   - **설정** 버튼 클릭
   - **동의 단계**: "카카오 로그인 시" 또는 "앱 사용 중 동의 시"
   - **동의 목적**: "사용자 식별 및 서비스 제공"
   - **저장** 클릭
...
**⚠️ 중요:**
- 닉네임은 반드시 **활성화**해야 합니다
- "동의 단계"를 "카카오 로그인 시"로 설정하면 자동으로 동의됩니다
- "앱 사용 중 동의 시"로 설정하면 사용자에게 별도 동의 팝업이 표시됩니다

### B. 동의항목 활성화 확인

설정 후 다시 **동의항목** 섹션을 확인하면:
- ✅ **닉네임**: 활성화됨 (초록색 체크)
- ✅ **프로필 사진**: 활성화됨 (선택사항)
